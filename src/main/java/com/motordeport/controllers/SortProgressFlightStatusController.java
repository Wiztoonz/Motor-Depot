...
public class SortProgressFlightStatusController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (session.getAttribute("Admin") != null) {
            session.setAttribute("ListFlights", FlightService.progressFlights());
        ...
        if (session.getAttribute("Driver") != null) {
            session.setAttribute("Flights", FlightService.progressFlights());
