...
public class SortOpenFlightStatusController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (session.getAttribute("Admin") != null) {
            session.setAttribute("ListFlights", FlightService.openFlights());
        ...
        if (session.getAttribute("Driver") != null) {
            session.setAttribute("Flights", FlightService.openFlights());
