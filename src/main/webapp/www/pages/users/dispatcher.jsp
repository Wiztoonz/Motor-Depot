...
<%@ include file="/WEB-INF/session/sessionDispatcher.jsp"%>
...
<body>
    ...
    <div class="wrapper">
        ...
        <ul id='dropdown' class='dropdown-content'>
            <li><a href="dispatcher/car"><fmt:message key="language.a.cars"/></a></li>
            <li><a href="dispatcher/flight"><fmt:message key="language.flights"/></a></li>
        </ul>
    </div>
